...
int main (int argc, char **argv)
{
  ...
  {
    xdump=opt_get("xdump");
    if (xdump && !xstrcmpi (xdump,"SQL"))
    {
      void dbf_dump_SQL_HEAD (DBF *dbf);
      void dbf_dump_SQL_TAIL (DBF *dbf);
      void dbf_dump_SQL_BODY (DBF *dbf, ui32);
      dbf->dbf_dump_HEAD=dbf_dump_SQL_HEAD;
      dbf->dbf_dump_TAIL=dbf_dump_SQL_TAIL;
      dbf->dbf_dump_BODY=dbf_dump_SQL_BODY;
    }
    else if (xdump && !xstrcmpi (xdump,"XML"))
    {
      void dbf_dump_XML_HEAD (DBF *dbf);
      void dbf_dump_XML_TAIL (DBF *dbf);
      void dbf_dump_XML_BODY (DBF *dbf, ui32);
      dbf->dbf_dump_HEAD=dbf_dump_XML_HEAD;
      dbf->dbf_dump_TAIL=dbf_dump_XML_TAIL;
      dbf->dbf_dump_BODY=dbf_dump_XML_BODY;
    }
    else if (!xdump || !xstrcmpi (xdump,"ASCII"))
    {
      void dbf_dump_ASCII_HEAD (DBF *dbf);
      void dbf_dump_ASCII_TAIL (DBF *dbf);
      void dbf_dump_ASCII_BODY (DBF *dbf, ui32);  
    ...
    {
      fprintf (stderr,"Error: Invalid `%s` in --xdump. \n",xdump);
      err=-1;
    }
  }
  ///////////////////////////////////////////////
